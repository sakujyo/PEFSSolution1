...
//    type MyTest() =
//
////        static member cp = System.Diagnostics.Process.GetCurrentProcess()
//
////        static member public measureCPUT (func) =
...
//
////        static member public measureCPUT (func : int -> unit) x =
////            let cp = System.Diagnostics.Process.GetCurrentProcess()
////            let t1 = cp.TotalProcessorTime
////            printfn "CPU Time 1: %A" (t1)
////            func x
...
////            printfn "Test CPU Time: %A" (t2 - t1)
//
//        //static member public measureCPUTime (x : 'a) = ()
//
//
////        member x.lazyARG a =
////            lazy(a)
//
////        member x.measureCPUTime (func : Lazy<obj * Constraints.EqualConstraint * string -> unit>) arg =
////        member x.measureCPUTime ((func : obj * Constraints.EqualConstraint * string -> unit), arg) =
////        member x.measureCPUTime (func : Lazy<obj * Constraints.IResolveConstraint * string -> unit>) (lazyarg : Lazy<'a>) arg2 arg3 =
////        member x.measureCPUTime func (lazyarg : Lazy<'a>) arg2 arg3 =
...
////            // Lazyなら遅延評価させることができる？
////            x.measureCPUTime Assert.That (PEFS.Problem_0000.run input, Is.EqualTo(result), sprintf "1234 * %A = %A" input result)
////            
//////            measureCPUTime (1)
//////            let t2 = cp.TotalProcessorTime
//////            printfn "Test CPU Time: %A" (t2 - t1)
...
//            //x.measureCPUTime (lazy(Assert.That)) (lazy(PEFS.Problem_0003.test input)) (Is.EqualTo(result)) (sprintf "prime factors of %A = %A" input result)
//            //Assert.That (PEFS.Problem_0003.test input, Is.EqualTo(result), sprintf "prime factors of %A = %A" input result)
////            let t2 = cp.TotalProcessorTime
////            printfn "Test CPU Time: %A" (t2 - t1)
//            // 2回目は速くなるか？
////            let t1 = cp.TotalProcessorTime
////            let dummy = test input
////            let t2 = cp.TotalProcessorTime
